...
class NPN:
    ...
    def create_model(self):
        ...
        cls_gate_linear = DenseLayer("cls_gate_linear", self.gate_vec_size)
        cls_gate_value = tf.sigmoid(cls_gate_linear(tf.concat([char_features, word_features], axis=1)))
        cls_features = char_features * cls_gate_value + word_features * (1 - cls_gate_value)
    ...
    def load_data_and_embedding(self):
        ...
        self.word2cnt = self.test_data.get_word_to_cnt(self.word2cnt)
